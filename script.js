...
// this sets the value of userInput to the user's entry
let userInput = prompt(q1)

// NESTED CONDITIONAL STATEMENTS
//1st
// Prompts returns the value entered aa a string. that is why double equals is used instead of triple equals. (aka strict equality)
if (userInput == 1) {
    userInput = prompt(q2);
